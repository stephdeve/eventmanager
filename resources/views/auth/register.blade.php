...
<body>
        ...
        <div class="auth-card">
            ...
            <div class="auth-body">
                ...
                <div class="google-section">
                    <a href="#" id="googleBtnRegister" class="google-btn">
    ...
    <div class="role-modal-backdrop" id="roleModalBackdropRegister" aria-hidden="true">
        <div class="role-modal" role="dialog" aria-modal="true" aria-labelledby="roleModalTitleRegister">
            <div class="role-modal-header" id="roleModalTitleRegister">Choisissez votre type de compte</div>
            ...
            <div class="role-modal-footer">
                <button class="btn-cancel" type="button" id="roleModalCancelRegister">Annuler</button>
            </div>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const roleModalBackdrop = document.getElementById('roleModalBackdropRegister');
            const openRoleModalBtn = document.getElementById('googleBtnRegister');
            const cancelRoleBtn = document.getElementById('roleModalCancelRegister');
            ...
            document.querySelectorAll('#roleModalBackdropRegister .role-btn').forEach(btn => {
            ...
            // Enhanced account type card selection
            const accountCards = document.querySelectorAll('.account-card');

            accountCards.forEach(card => {
                card.addEventListener('click', function() {
                    // Remove selected from all cards with animation
                    accountCards.forEach(c => {
                        c.classList.remove('selected');
                        c.style.transform = 'scale(1)';
                    });
                    
                    // Add selected to clicked card with animation
            ...
            registerForm.addEventListener('submit', function(e) {
                ...
                if (password !== passwordConfirmation) {
                    isValid = false;
                    document.getElementById('password_confirmation').style.borderColor = '#FCA5A5';
                    document.getElementById('password_confirmation').style.animation = 'errorShake 0.5s ease-in-out';
                }
            ...
            const formElements = document.querySelectorAll('.account-type-section, .form-group, .google-btn, .separator, .auth-links');
