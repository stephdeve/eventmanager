                ...
                <form action="{{ route('events.update', $event) }}" method="POST" enctype="multipart/form-data"
                                ...
                                @if ($event->cover_image)
                                    <div class="mb-4">
                                        ...
                                        <img src="{{ asset('storage/' . $event->cover_image) }}"
                                            class="object-cover rounded-2xl" alt="Image actuelle de l'événement"
                                            class="current-image">
                                    </div>
                                @endif
                    ...
                    <div class="form-card p-8 rounded-2xl mb-8">
                            ...
                            <div>
                                <h3 class="text-xl font-bold text-slate-900">Stories Vidéo
                                    @if (auth()->user()->subscription_plan !== 'pro' || !auth()->user()->hasActiveSubscription())
                                        <span
                                            class="ml-2 px-3 py-1 bg-gradient-to-r from-purple-500 to-pink-500 text-white text-xs font-semibold rounded-full">
                                            PRO
                                        </span>
                                    @endif
                                </h3>
                                <p class="text-sm text-slate-600">Publiez des vidéos courtes pour promouvoir votre
                                    événement
                                    (15-60s)</p>
                            </div>
                        </div>
                        ...
                        @if (auth()->user()->subscription_plan === 'pro' && auth()->user()->hasActiveSubscription())
                            ...
                            <div class="mb-6">
                                ...
                                <div class="flex border-b border-slate-300 mb-6">
                                    <button type="button"
                                        class="story-tab-btn px-6 py-3 font-semibold text-indigo-600 border-b-2 border-indigo-600"
                                        data-tab="upload">
                                        Upload Vidéo
                                    </button>
                                    <button type="button"
                                        class="story-tab-btn px-6 py-3 font-semibold text-slate-600 hover:text-indigo-600 transition"
                                        data-tab="url">
                                        URL Externe
                                    </button>
                                </div>
                                ...
                                <div id="upload-tab-content" class="story-tab-content">
                                    <form action="{{ route('stories.store', $event) }}" method="POST"
                                        ...
                                        <div
                                            ...
                                            <label for="story-video-input"
                                                class="cursor-pointer flex flex-col items-center gap-3">
                                                <svg class="w-12 h-12 text-indigo-500" fill="none"
                                                    stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                        d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                                                </svg>
                                                <div class="text-center">
                                                    <p class="font-semibold text-indigo-700">Cliquez pour uploader une
                                                        vidéo</p>
                                                    <p class="text-sm text-slate-600 mt-1">MP4, MOV, WebM • Max 50MB •
                                                        15-60
                                                        secondes</p>
                                                    <p class="text-xs text-slate-500 mt-2">📱 Format portrait (9:16)
                                                        recommandé</p>
                                                </div>
                                            </label>
                                            ...
                                            <div id="upload-progress" class="hidden mt-4">
                                                <div class="flex items-center justify-between mb-2">
                                                    <span class="text-sm font-medium text-slate-700">Upload en
                                                        cours...</span>
                                                    <span id="progress-percent"
                                                        class="text-sm font-bold text-indigo-600">0%</span>
                                                </div>
                                        ...
                                        <div class="mt-4 flex items-center gap-4">
                                            <label class="flex items-center gap-2">
                                                ...
                                                <span class="text-sm font-medium text-slate-700">Publier
                                                    immédiatement</span>
                                            </label>
                                        </div>
                                    </form>
                                    ...
                                    <form action="{{ route('stories.store', $event) }}" method="POST"
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            <div class="grid grid-cols-3 gap-3">
                                                <div
                                                    class="p-4 border-2 border-slate-200 rounded-lg text-center hover:border-red-400 transition">
                                                    <svg class="w-8 h-8 mx-auto mb-2 text-red-600" fill="currentColor"
                                                        viewBox="0 0 24 24">
                                                        <path
                                                ...
                                                <div
                                                    class="p-4 border-2 border-slate-200 rounded-lg text-center hover:border-black transition">
                                                    <svg class="w-8 h-8 mx-auto mb-2" fill="currentColor"
                                                        viewBox="0 0 24 24">
                                                        <path
                                                ...
                                                <div
                                                    class="p-4 border-2 border-slate-200 rounded-lg text-center hover:border-pink-400 transition">
                                                    <svg class="w-8 h-8 mx-auto mb-2 text-pink-600" fill="currentColor"
                                                        viewBox="0 0 24 24">
                                                        <path
                                ...
                                <div class="border-t border-slate-200 pt-6">
                                    ...
                                    <div id="stories-list" class="space-y-3">
                                        @foreach ($event->stories()->orderBy('order')->get() as $story)
                                            <div class="story-item bg-white border border-slate-200 rounded-xl p-4 flex items-center gap-4 hover:border-indigo-300 transition"
                                                ...
                                                {{-- Video thumbnail --}}
                                                <div
                                                    class="w-16 h-28 bg-slate-100 rounded-lg overflow-hidden flex-shrink-0">
                                                ...
                                                <div class="flex-1">
                                                    <div class="flex items-center gap-2 mb-1">
                                                        <span class="font-semibold text-slate-900">Story
                                                            #{{ $story->order + 1 }}</span>
                                                        @if ($story->is_active)
                                                            <span
                                                    ...
                                                    <div class="flex items-center gap-4 text-sm text-slate-600">
                                                        <span>
                                                            ...
                                                            {{ $story->duration }}s</span>
                                                        <span>
                                                            <i class="fas fa-eye mr-1 text-yellow-600"></i>
                                                            {{ number_format($story->views_count) }} vues</span>
                                                        <span>
                        ...
                        @else
                            ...
                            <div
                                class="relative overflow-hidden bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-2xl p-8 border-2 border-purple-200 dark:border-purple-800">
                                {{-- Background decoration --}}
                                <div
                                    class="absolute top-0 right-0 -mt-4 -mr-4 w-32 h-32 bg-purple-200 dark:bg-purple-800 rounded-full opacity-20 blur-3xl">
                                </div>
                                <div
                                    class="absolute bottom-0 left-0 -mb-4 -ml-4 w-32 h-32 bg-pink-200 dark:bg-pink-800 rounded-full opacity-20 blur-3xl">
                                </div>
                                ...
                                <div class="relative text-center">
                                    {{-- Icon --}}
                                    <div
                                        class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl shadow-xl mb-6">
                                    ...
                                    <p class="text-slate-600 dark:text-slate-300 mb-6 max-w-md mx-auto">
                                        Les <strong>Stories Vidéo</strong> sont une fonctionnalité exclusive réservée aux
                                        membres avec un abonnement <strong>Élite (Pro)</strong>.
                                    </p>

                                    {{-- Features list --}}
                                    <div class="mb-8 text-left max-w-md mx-auto">
                                        <p class="text-sm font-semibold text-slate-700 dark:text-slate-300 mb-3">Avec
                                            l'abonnement Pro, vous pouvez:</p>
                                        <ul class="space-y-2 text-sm text-slate-600 dark:text-slate-400">
                                            <li class="flex items-start gap-2">
                                                ...
                                                <span>📹 Publier des vidéos courtes (15-60s) pour promouvoir vos
                                                    événements</span>
                                            </li>
                                            <li class="flex items-start gap-2">
                                                <svg class="w-5 h-5 text-purple-500 flex-shrink-0 mt-0.5" fill="none"
