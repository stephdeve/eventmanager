                ...
                <div class="grid form-grid gap-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="file-upload @if($event->cover_image) hidden @endif" id="file-upload-area">
                            ...
                            @if($event->cover_image)
                                <button type="button" id="change-image-btn" class="cancel-btn w-full mt-3 text-center">
                                    Changer l'image
                                </button>
                            @endif
                        ...
                        <!-- Restriction d'âge -->
                        <div class="checkbox-card @if(old('is_restricted_18', $event->is_restricted_18)) checked @endif" id="age-restriction-card">
