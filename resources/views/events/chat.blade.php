...
<div class="chat-page-container">
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="mb-6">
            <a href="{{ route('events.show', $event) }}" class="back-button">
        ...
        <div class="chat-container">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <span class="text-slate-200 text-sm font-medium">Chat en temps réel</span>
                        </div>
                    </div>

                    <div class="online-indicator">
                        <div class="online-dot"></div>
                        <span class="text-white font-medium">Participants: <span id="online-count" class="font-bold">0</span></span>
                    </div>
                </div>
            </div>
            ...
            <div id="messages" class="messages-area">
                ...
                @empty
                    ...
                    <div id="empty-state" class="empty-state">
                        ...
                        <p class="empty-description">Soyez le premier à envoyer un message</p>
                    </div>
                @endforelse
            </div>
            ...
            <div class="input-area">
                ...
                <div class="input-wrapper">
                    <input id="chat-input" type="text" placeholder="Écrire un message..." class="chat-input" @if($readOnly) disabled @endif />
                    <button id="send-btn" class="send-button" @if($readOnly) disabled @endif>
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
(function(){
    ...
    // WebSocket/Real-time functionality (if available)
    if (typeof Echo !== 'undefined' && !readOnly) {
        Echo.join(`event.${eventId}`)
            ...
            .joining((user) => {
                ...
                addSystemMessage(`${user.name} a rejoint la discussion`);
            })
            .leaving((user) => {
    ...
    function updateOnlineCount(count) {
        ...
        if (onlineCountElement) {
            ...
            onlineCountElement.style.animation = 'countPulse 0.6s ease-out';
            setTimeout(() => {
    ...
    function addSystemMessage(message) {
        ...
        systemMessage.innerHTML = `
            <div style="text-align: center; margin: 1rem 0;">
                <span style="background: rgba(255, 255, 255, 0.1); backdrop-filter: blur(10px); 
    ...
    function addMessageToChat(message) {
        ...
        // This would add the message to the chat UI
        scrollToBottom();
    }
    ...
    if (sendButton && chatInput && !readOnly) {
    ...
    function sendMessage() {
        ...
        messageDiv.className = 'own-message message-bubble';
