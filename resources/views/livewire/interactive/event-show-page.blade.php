                            ...
                            <div class="space-y-4">
                                <h3 class="font-bold text-slate-800 text-lg flex items-center gap-2">
                                    <svg class="w-5 h-5 text-black" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M19.589 6.686a4.793 4.793 0 01-3.77-4.245V2h-3.445v13.672a2.896 2.896 0 01-5.201 1.743l-.002-.001.002.001a2.895 2.895 0 113.183-4.51v-3.5a6.329 6.329 0 105.608 6.145 6.33 6.33 0 003.771-11.355z"/>
                                    </svg>
                                    TikTok Live
                        ...
                        @unless($event->youtube_url || $event->tiktok_url)
                            <div class="col-span-2">
                                <div class="empty-state">
                                    ...
                                    <p class="empty-description">Les streams seront bientôt disponibles. Revenez plus tard !</p>
                                </div>
                            </div>
                        @endunless
                    </div>
            ...
            <div class="content-card">
                ...
                <div class="features-grid">
                    ...
                    <div class="feature-card">
                        ...
                        <p class="feature-description">Participez aux défis excitants et gagnez des récompenses exclusives</p>
                    </div>
                    ...
                    <div class="feature-card">
                        ...
                        <p class="feature-description">Soutenez vos participants préférés et encouragez leur performance</p>
                    </div>
                    ...
                    <div class="feature-card">
                        ...
                        <p class="feature-description">Suivez les performances en temps réel avec notre classement interactif</p>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const cards = document.querySelectorAll('.content-card, .participant-card, .feature-card, .stat-card, .quick-action');
    ...
    const animatedElements = document.querySelectorAll('.content-card, .feature-card, .participant-card, .stat-card');
