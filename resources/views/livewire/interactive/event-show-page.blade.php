            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="content-card lg:col-span-2">
                    ...
                    <div class="stats-grid">
                        <div class="stat-card">
                            <div class="stat-value dark:text-white">{{ number_format($stats['viewers'] ?? 0) }}</div>
                            <div class="stat-label dark:text-slate-400">Spectateurs</div>
                        </div>
                        <div class="stat-card">
                            <div class="stat-value dark:text-white">{{ number_format($stats['votes'] ?? 0) }}</div>
                            <div class="stat-label dark:text-slate-400">Votes</div>
                        </div>
                        <div class="stat-card">
                            <div class="stat-value dark:text-white">{{ number_format($stats['participants'] ?? 0) }}
                            </div>
                            <div class="stat-label dark:text-slate-400">Participants</div>
                        </div>
                        <div class="stat-card">
                            <div class="stat-value dark:text-white">{{ number_format($stats['interactions'] ?? 0) }}
                            </div>
