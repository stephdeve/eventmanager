    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="form-card rounded-2xl border p-8">
            ...
            <form wire:submit.prevent="save" class="space-y-8">
                        ...
                        <div class="bg-blue-50 border border-blue-200 rounded-xl p-4">
                            ...
                            <div class="text-2xl font-bold text-blue-700" id="real-vote-cost">
                                @if ($premium_vote_cost && $coin_price_minor)
                                    {{ number_format(($premium_vote_cost * $coin_price_minor) / 100, 0, ',', ' ') }} F
                                    CFA
                                @else
                                    -
                                @endif
                ...
                <div
                    class="flex flex-col sm:flex-row justify-end space-y-4 sm:space-y-0 sm:space-x-4 pt-8 border-t border-[#E0E7FF]">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateCalculations() {
                const voteCost = parseFloat(document.querySelector(
                    'input[wire\\:model\\.defer="premium_vote_cost"]')?.value) || 0;
                const coinPrice = parseFloat(document.querySelector(
                    'input[wire\\:model\\.defer="coin_price_minor"]')?.value) || 0;
