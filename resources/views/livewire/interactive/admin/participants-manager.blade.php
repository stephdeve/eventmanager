        ...
        <div class="form-card rounded-2xl border p-8 mb-8">
            ...
            <form wire:submit.prevent="save" class="space-y-6">
                ...
                <div class="form-group">
                    ...
                    <textarea rows="3" wire:model.defer="bio"
                              class="form-input @error('bio') error @enderror resize-none"
                ...
                <div class="overflow-hidden rounded-xl border border-gray-200">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gradient-to-r from-gray-50 to-blue-50">
                            <tr>
                                <th class="px-6 py-4 text-left text-xs font-semibold text-[#1E3A8A] uppercase tracking-wider">
                                    Participant
                                </th>
                                <th class="px-6 py-4 text-left text-xs font-semibold text-[#1E3A8A] uppercase tracking-wider">
                                    Pays
                                ...
                                <th class="px-6 py-4 text-right text-xs font-semibold text-[#1E3A8A] uppercase tracking-wider">
                                    Actions
                                </th>
                            </tr>
                        </thead>
                                        ...
                                        <div class="flex items-center space-x-3">
                                            @if($participant->photo_path)
                                                <div class="flex-shrink-0 w-10 h-10 bg-gray-200 rounded-full overflow-hidden">
                                                    <img src="{{ $participant->photo_path }}" alt="{{ $participant->name }}" class="w-full h-full object-cover">
                                                </div>
                                            @else
