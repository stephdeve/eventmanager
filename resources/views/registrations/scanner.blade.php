        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl">
            <div class="px-6 py-5 border-b border-gray-200 sm:px-8">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">Scanner un billet</h1>
                        <p class="mt-1 text-sm text-gray-600">Scannez les codes QR pour valider les entrées</p>
                    </div>
                    <div id="scanner-status" class="px-4 py-2 bg-blue-100 text-blue-800 text-sm font-medium rounded-full flex items-center">
            ...
            <div class="px-4 py-6 sm:p-8">
                ...
                <div class="flex flex-col items-center">
                    <div id="reader" class="relative w-full max-w-md aspect-square bg-gray-900 rounded-xl overflow-hidden shadow-2xl">
                        <!-- Cadre de scan -->
                        <div id="scanner-view" class="absolute inset-0 flex items-center justify-center">
                            <div class="text-center p-6 bg-white bg-opacity-90 rounded-lg">
                                <div class="mx-auto flex items-center justify-center h-16 w-16 rounded-full bg-blue-100 mb-3">
                                    <svg class="h-8 w-8 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4M4 12h4m12 0h.01M5 8h2a1 1 0 001-1V5a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1zm12 0h2a1 1 0 001-1V5a1 1 0 00-1-1h-2a1 1 0 00-1 1v2a1 1 0 001 1zM5 20h2a1 1 0 001-1v-2a1 1 0 00-1-1H5a1 1 0 00-1 1v2a1 1 0 001 1z" />
                                    </svg>
                                </div>
                                <h3 class="text-lg font-medium text-gray-900">Prêt à scanner</h3>
                                <p class="mt-1 text-sm text-gray-500">Appuyez sur le bouton pour démarrer le scan</p>
                            </div>
                        </div>
                        ...
                        <div class="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/80 to-transparent">
                            <div class="flex flex-col sm:flex-row justify-center gap-3">
                                <button type="button" id="start-scanner" class="w-full sm:w-auto flex items-center justify-center px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg shadow-md transition-all duration-200 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                ...
                                <button type="button" id="stop-scanner" class="hidden w-full sm:w-auto items-center justify-center px-6 py-3 bg-red-600 hover:bg-red-700 text-white font-medium rounded-lg shadow-md transition-all duration-200 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="absolute inset-0 border-8 border-blue-400 border-opacity-50 rounded-lg m-2 pointer-events-none">
            ...
            <!-- Résultats du scan -->
            <div id="scanner-result" class="hidden p-4 mb-6 bg-gray-50 rounded-lg border border-gray-200">
                <h3 class="text-lg font-medium text-gray-800 mb-3">Résultat du scan</h3>
