...
<div class="space-y-10">
    <div class="rounded-3xl bg-gradient-to-br from-indigo-500 via-purple-500 to-sky-500 p-8 text-white shadow-xl">
        <div class="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <p class="mt-3 text-sm text-white/80">Suivez l'activité de la plateforme en temps réel : utilisateurs, inscriptions, événements et organisateurs les plus actifs.</p>
            </div>
    ...
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
        ...
        <div class="rounded-3xl bg-white p-6 shadow-xl">
            <div class="flex items-center justify-between">
                <h2 class="text-lg font-semibold text-slate-800">Inscriptions mensuelles</h2>
                <span class="rounded-full bg-indigo-50 px-3 py-1 text-xs font-semibold text-indigo-600">6 derniers mois</span>
            </div>
            <div class="mt-6">
    ...
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
        <div class="rounded-3xl bg-white p-6 shadow-xl">
            <div class="flex items-center justify-between">
                <h2 class="text-lg font-semibold text-slate-800">Participation par événement</h2>
        ...
        <div class="rounded-3xl bg-white p-6 shadow-xl">
            <div class="flex items-center justify-between">
                <h2 class="text-lg font-semibold text-slate-800">Capacité vs Inscriptions</h2>
                <span class="text-xs text-slate-400">Top 5 événements</span>
            </div>
            <div class="mt-6">
    ...
    <div class="rounded-3xl bg-white p-6 shadow-xl">
        <div class="flex items-center justify-between">
            <h2 class="text-lg font-semibold text-slate-800">Organisateurs les plus actifs</h2>
            <span class="text-xs text-slate-400">Top 5</span>
        </div>
        <div class="mt-6">
...
@push('scripts')
<script type="module">
    import { initAdminDashboardCharts } from '{{ Vite::asset("resources/js/components/admin-dashboard-charts.js") }}';
